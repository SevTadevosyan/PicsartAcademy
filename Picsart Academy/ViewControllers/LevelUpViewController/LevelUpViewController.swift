...
class LevelUpViewController: UIViewController {
    ...
    @IBOutlet weak var animatedLabel1: AnimatedMaskLabel!
    @IBOutlet weak var animatedLabel2: AnimatedMaskLabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if Bundle.main.preferredLocalizations.first == "hy" {
            ...
            runningLabel.text = "Սկսնակ չե՞ս, միացիր LevelUp Bootcamp-ին           "

        } else if Bundle.main.preferredLocalizations.first == "en" {
            runningLabel.text = "Not a beginner? Join the LevelUp Bootcamp!          "
        }
    ...
    @IBAction func goToHomeVC(_ sender: UITapGestureRecognizer) {
...
extension LevelUpViewController: UITabBarControllerDelegate {
